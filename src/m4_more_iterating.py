...
def run_test_count_positive_sines():
    ...
    # Done 6 (continued):  Add your 1 ADDITIONAL test here:
    # Test 11:
    expected = 2
    actual = count_positive_sines([3,4,5,7])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 68
    actual = sum_first_n([28, -10, 50, 5], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 3
    actual = sum_first_n([148, -100, -50, 5], 4)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
